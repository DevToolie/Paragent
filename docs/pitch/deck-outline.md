...
Compression of [`narrative.md`](./narrative.md). One point per slide. Vertical remains **TBD / search in progress**.
...
| 7 | The insight | Invert: counterparty labor → permanently browser-only + multiplicity across portals | Pivot hypothesis | Wave-2 shared context / founder pivot — **ASSUMED**; pending Track 2 |
| 8 | Falsifiability | Track 2 can kill this thesis (API / EDI / intermediary) | C4/C5 gate design in Wave pack | Wave pack Track 2 method — ASSUMED process; outcome **PENDING C5** |
| 9 | Vertical | Search in progress — not locked | C5 has not adjudicated | — **PENDING C5** |
...
| 20 | What would make us wrong | Replay below threshold; intermediary owns labor; ToS blocks; models too cheap; two vertical FAILs | Explicit kill table | [narrative.md](./narrative.md) §wrong — mix PROVEN (A6/A8 process) + PENDING/ASSUMED kills |
...
- Slide 9 must say **TBD** — C5 has not run.
...
- Whether A7 portal-fill remains the lead after C1–C5 — **PENDING**.
