...
| 18 | Backup lead — closed, not a live lead | Seller-side portal questionnaire fill **was** a conditionally credible wedge at A7 (2026-07-24); C4 ALREADY_SOLVED (QAuto category) + C5 FAIL closed it | A7 scout; Chrome extensions as demand signal | [A7-backup.md](../research/census-week0/A7-backup.md) (access_date 2026-07-24) — PROVEN as scout notes; never a vertical lock, and **closed as a wedge** — [adversary-report.md](../research/vertical-search/adversary-report.md); [DECISION.md](../research/vertical-search/DECISION.md); [ADR-0004](../decisions/ADR-0004-vertical-track2-fail.md) |
...
| 21 | Ask | Support to finish the Track 1 gate number — not to scale an unmeasured cache. Track-2 adjudication is **already closed** (FAIL, no lock), so it is not part of the ask | Status table | [README.md](../../README.md) — PROVEN status; ask details **ASSUMED** / founder; Track-2 closure — [DECISION.md](../research/vertical-search/DECISION.md); [ADR-0004](../decisions/ADR-0004-vertical-track2-fail.md) |
