...
| `data-testid Apply changes and go back to dashboard` | testid | [`PanelEditor.tsx`](https://raw.githubusercontent.com/grafana/grafana/v9.5.21/public/app/features/dashboard/components/PanelEditor/PanelEditor.tsx) line 362, `data-testid={selectors...applyButton}`; selector value at `components.ts` line 137 | step 7 |
